...
- **Display arithmetic operation on screen**
...
- [Open live demo](https://kweeka1.github.io/math-magicians/dist/)
...
```sh
  git clone git@github.com:Kweeka1/math-magicians.git
  cd math-magicians
```
...
Feel free to check the [issues page](https://github.com/Kweeka1/math-magicians/issues).
